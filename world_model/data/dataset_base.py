    ...
    def build_datasets(self, datasets_metainfo, data_status):
        ...
        for grouped_dataset_name, dataset_args in datasets_metainfo.items():
            ...
            for item in dataset_names:
                ...
                if 'prompt_path' in meta_info.keys():
                    # prompt file
                    if 'prompt_path_list' not in dataset_args.keys():
                        dataset_args['prompt_path_list'] = [meta_info['prompt_path']]
                    else:
                        dataset_args['prompt_path_list'].append(meta_info['prompt_path'])
